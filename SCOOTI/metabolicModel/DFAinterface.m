function obj_flux_out=DFAinterface(model_path, obj, obj_type, obj_c, root_path, data_path, upsheet, dwsheet, out_name, ctrl, kappa, genekoflag, rxnkoflag, medium, medium_perturbation, FVAflag, model_name, CFR_model, extra_weight, algorithm)
...
%% Save settings in metadata
  ...
  metadata.media_perturbation = medium_perturbation;
...
%% main function for DFA
  function run_simulation(model, excelname),
      ...
      T = readtable(data_path,'Sheet',upsheet);
      ...
      upsheet,kappa,1E-3,genekoflag,rxnkoflag,0,[],[]);
