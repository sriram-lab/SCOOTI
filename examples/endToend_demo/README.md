...
Outputs
-------
- Flux predictions: `examples/endToend_demo/out/unconstrained_models/` and `.../constrained_models/`
- Inference results: `examples/endToend_demo/out/regression_models/`

Cleanup
-------
```
rm -rf examples/endToend_demo/out
```
