![ICON](./icon.png)
# SCOOBI
`SCOOBI: Single Cell Optimization OBjective Inference` is a data-driven computational framework to identify cell-specific objectives from transcriptomics data.
